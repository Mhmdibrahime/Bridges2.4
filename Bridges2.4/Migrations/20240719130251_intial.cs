        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_schedules_stations_ArrivalStationID",
                        column: x => x.ArrivalStationID,
                        principalTable: "stations",
                        principalColumn: "StationID");
                    table.ForeignKey(
                        name: "FK_schedules_stations_DepartureStationID",
                        column: x => x.DepartureStationID,
                        principalTable: "stations",
                        principalColumn: "StationID");
                    table.ForeignKey(
                        name: "FK_schedules_train_TrainID",
                        column: x => x.TrainID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatPreference = table.Column<string>(type: "nvarchar(max)", nullable: false),
